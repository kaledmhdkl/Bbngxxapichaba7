...
MASTER_ACCOUNT_ID = '4173854682'  # عدل حسب حسابك الرئيسي
        ...
        if '/bngx' in command[:5]:
                try:
                        ...
                        # Ghost account logic (uses master info)
                                ...
                                # إرسال Ghost packet 99 مرة مع تأخير 0.01 ثانية
                                for _ in range(999):
                                        self.socket_client.send(
                                                ghost_pakcet(shared_0500_info['idT'], self.nm, shared_0500_info['squad'], self.key, self.iv)
                                        )
                                        time.sleep(0.01)
...
def execute_command_all():
    ...
    ghost_names = {
        "4173854682": "insta: kha_led_mhd",
        "4173854724": "BNGX IS THE BEST",
        "4173854749": "TTLG @BNGXXXX",
        "4173854770": "BNGX WILL  BANNED YOU",
        "4173854799": "FELLOW ME",
        "4173854828":"B    N    G    X"
}
